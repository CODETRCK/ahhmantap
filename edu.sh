...
wget -q -O /usr/local/bin/edussh-nontls https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/edu-op.py
