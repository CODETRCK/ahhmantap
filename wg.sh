...
echo -e "${Info} Wireguard VPS AutoScript by naikstore"
...
# Tambahan
cd /usr/bin
wget -O mwg "https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/mwg.sh"
wget -O add-wg "https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/renew-wg.sh"
chmod +x mwg
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
