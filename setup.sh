...
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/cf.sh && chmod +x cf.sh && ./cf.sh
sleep 2
#install ssh ovpn
echo -e "$green   =============================================$NC"
echo -e "$green                 Install SSH OVPN               $NC"
echo -e "$green   =============================================$NC"
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
echo -e "$green   =============================================$NC"
echo -e "$green                     Install SSR                $NC"
echo -e "$green   =============================================$NC"
sleep 2
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
echo -e "$green   =============================================$NC"
echo -e "$green                 Install Wireguard              $NC"
echo -e "$green   =============================================$NC"
sleep 2
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install v2ray
echo -e "$green   =============================================$NC"
echo -e "$green                  Install V2RAY                 $NC"
echo -e "$green   =============================================$NC"
wget http://raw.githubusercontent.com/CODETRCK/ahhmantap/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install xray
echo -e "$green   =============================================$NC"
echo -e "$green                      Install XRAY              $NC"
echo -e "$green   =============================================$NC"
sleep 2
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/install-xray.sh && chmod +x install-xray.sh && screen -S xray ./install-xray.sh
#install L2TP
echo -e "$green   =============================================$NC"
...
echo -e "$green   =============================================$NC"
sleep 2
wget https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/install-grpc.sh && chmod +x install-grpc.sh && screen -S grpc ./install-grpc.sh
clear
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/CODETRCK/ahhmantap/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
echo "echo '             Menu Style by @CODETRCK            '" >> .profile
clear
echo " "
echo "DAH SIAP BOSS!!"
echo " "
